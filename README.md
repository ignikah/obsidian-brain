...
1. **[[Identity/USER]]** — 你的偏好、溝通風格與工作習慣
...
.
├── Inbox/          # 收集箱 — 未分類內容
├── 1_Projects/     # 項目 — 有截止日期的事
├── 2_Areas/        # 領域 — 持續維護的責任
├── 3_Resources/    # 資源 — 可複用的知識
├── 4_Archives/     # 歸檔 — 已完成的內容
...
有空時
  /intake
    → 將 Inbox 內容分類到 1_Projects / 2_Areas / 3_Resources
...
```
L1  Identity/Agents/CKO.md  → 系統規則（AI 讀取，CLAUDE.md / AGENTS.md 皆重導向至此）
